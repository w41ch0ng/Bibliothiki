...
<nav class="navbar navbar-expand-lg">
		...
		Bibliothiki</a>
            ...
            <form class="d-flex" role="search" action="${pageContext.request.contextPath}/Books" method="get" onsubmit="handleSearch(event)">
                <input class="form-control me-2" type="search" placeholder="Find Books..." aria-label="Search" name="query">
...
<div id="booksContainer" class="container mt-3"></div>
